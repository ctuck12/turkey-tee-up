                ...
                <div className="flex items-center justify-center gap-1.5">
                  ...
                  {currentHoleData?.isCtpHole && (
                    currentHoleData.par === 3
                      ...
                      : <span className="text-[10px] font-bold px-1.5 py-0.5 rounded-md border uppercase bg-emerald-600/20 text-emerald-700 border-emerald-600/40">LD</span>
                  )}
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <span className="flex items-center gap-1 min-w-0 text-[11px] font-sans-app">
                      {lead?.playerName ? (
                        <>
                          <span className="shrink-0 text-[9px] font-bold uppercase tracking-wide text-[#1a2744]/55">Leader</span>
